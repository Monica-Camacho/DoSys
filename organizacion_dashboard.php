    ...
    <div class="container-fluid bg-light py-5">
        <div class="container">
            <div>
                ...
                <p class="fs-5 text-muted mb-0">Bienvenido, [Nombre del Admin]. Gestiona el impacto de tu organización.</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 text-center">
                            ...
                            <a href="organizacion_solicitudes.php" class="btn btn-warning w-100 mb-2 p-3">Validar Solicitudes</a>
                            <a href="organizacion_donantes.php" class="btn btn-info text-white w-100 mb-2 p-3">Gestionar Donantes</a>
