            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    <select name="tipo_id" class="form-select">
                        ...
                        <option value="1" <?php echo ($tipo_id == 1) ? 'selected' : ''; ?>>Tipo 1 (Sangre)</option>
                        <option value="2" <?php echo ($tipo_id == 2) ? 'selected' : ''; ?>>Tipo 2 (Medicamentos)</option>
                        <option value="3" <?php echo ($tipo_id == 3) ? 'selected' : ''; ?>>Tipo 3 (Otros)</option>
                    </select>
                </div>
