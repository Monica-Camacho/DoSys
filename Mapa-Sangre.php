            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Bancos de Sangre en tu zona</div>
                </div>
                <div class="card-body">
    ...
    <script>
      ...
      function agregarMarcador(punto) {
        ...
        const marcador = new google.maps.Marker({
          ...
          title: punto.nombre,
          icon: {
            url: "assets/img/icon/sangre.png", // Ruta de la imagen personalizada
      ...
      function seleccionarLugar(nombre, latitud, longitud) {
        ...
        window.location.href = "Con-Solicitar-Sangre.html";
      }
    </script>
