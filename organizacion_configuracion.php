...
// Se busca la organización, su estado, y el rol del usuario logueado
$sql_org = "SELECT op.id, op.nombre_organizacion, op.estado, u.rol_id 
            FROM organizaciones_perfil op
            JOIN usuarios_x_organizaciones uxo ON op.id = uxo.organizacion_id
            JOIN usuarios u ON uxo.usuario_id = u.id
            WHERE uxo.usuario_id = ?";
$stmt_org = $conexion->prepare($sql_org);
$stmt_org->bind_param("i", $admin_id);
$stmt_org->execute();
$organizacion = $stmt_org->get_result()->fetch_assoc();
$stmt_org->close();
...
<head>
    <meta charset="utf-8">
    <title>DoSys - Configuración de Organización</title>
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="container">
            <div>
                <h1 class='display-5 mb-0'>Configuración de la Organización</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <?php if ($organizacion['estado'] == 'Activa'): ?>
                        <div class="card border-danger shadow-sm">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6>Desactivar cuenta de la organización</h6>
                                        <p class="text-muted mb-0 small">Tu organización dejará de ser visible y no podrá validar nuevas solicitudes. Podrás reactivarla más tarde.</p>
                                    </div>
                    ...
                    <?php else: ?>
                        <div class="card border-success shadow-sm">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6>Reactivar cuenta de la organización</h6>
                                        <p class="text-muted mb-0 small">Tu organización está actualmente inactiva. Reactívala para volver a ser visible y gestionar solicitudes.</p>
                                    </div>
    ...
    <div class="modal fade" id="confirmacionModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="auth/gestionar_cuenta_org.php" method="POST">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        confirmacionModal.addEventListener('show.bs.modal', function (event) {
            ...
            if (accion === 'desactivar') {
                modalTexto.textContent = 'Para confirmar la DESACTIVACIÓN de tu organización, por favor introduce tu contraseña.';
                modalBoton.className = 'btn btn-danger';
                modalBoton.textContent = 'Sí, Desactivar';
            } else if (accion === 'reactivar') {
                modalTexto.textContent = 'Para confirmar la REACTIVACIÓN de tu organización, por favor introduce tu contraseña.';
