                    ...
                    <div class="card border-danger shadow-sm">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6>Eliminar cuenta de la organización</h6>
                                    <p class="text-muted mb-0 small">Esta acción es permanente y eliminará todos los datos de la organización y sus voluntarios.</p>
                                </div>
