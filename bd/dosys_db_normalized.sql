...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2025 a las 00:52:13
...
--
-- Base de datos: `dosys_db_normalized`
--
...
CREATE TABLE `empresas_perfil` (
  ...
  `direccion_fiscal_id` int(11) DEFAULT NULL,
...
INSERT INTO `empresas_perfil` (`usuario_id`, `nombre_comercial`, `razon_social`, `rfc`, `telefono_empresa`, `direccion_fiscal_id`, `direccion_comercial_id`, `descripcion`, `representante_id`, `empresa_padre_id`) VALUES
(10, 'empresa1', 'empresa1', 'empresa1', NULL, NULL, NULL, NULL, 5, NULL),
(12, 'empre2', 'empre2', 'empre2', NULL, NULL, NULL, NULL, 6, NULL),
(15, 'Farm', 'Farma', 'FAH850101XXX', '9931112233', 2, NULL, NULL, 1, NULL),
(18, 'Farmacias del A', 'S.A. De C.V.', 'FARMACIA', NULL, NULL, NULL, NULL, 10, NULL);
...
INSERT INTO `organizaciones_perfil` (`usuario_id`, `nombre_organizacion`, `cluni`, `logo_url`, `direccion_id`, `mision`, `representante_id`, `organizacion_padre_id`) VALUES
(3, 'Cruz Verde Tabasco', 'CVT123456789', NULL, 3, 'Proveer ayuda médica y humanitaria a la comunidad de Tabasco.', 2, NULL),
(13, 'org1', 'org1', NULL, NULL, NULL, 7, NULL);
...
ALTER TABLE `donantes_beneficios`
  ...
  ADD KEY `fk_donantes_beneficios_donaciones` (`donacion_id`),
  ADD KEY `fk_donantes_beneficios_usuarios` (`usuario_id`),
  ADD KEY `fk_donantes_beneficios_empresas_apoyos` (`apoyo_id`);
...
ALTER TABLE `empresas_apoyos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_empresas_apoyos_usuarios` (`empresa_id`),
  ADD KEY `fk_empresas_apoyos_tipos_apoyo` (`tipo_apoyo_id`);
...
ALTER TABLE `empresas_perfil`
  ...
  ADD KEY `fk_empresas_perfil_dir_fiscal` (`direccion_fiscal_id`),
  ADD KEY `fk_empresas_perfil_dir_comercial` (`direccion_comercial_id`),
  ADD KEY `fk_empresas_perfil_representantes` (`representante_id`),
  ADD KEY `fk_empresas_perfil_padre` (`empresa_padre_id`);
...
ALTER TABLE `organizaciones_perfil`
  ADD PRIMARY KEY (`usuario_id`),
  ADD KEY `fk_organizaciones_perfil_direcciones` (`direccion_id`),
  ADD KEY `fk_organizaciones_perfil_representantes` (`representante_id`),
  ADD KEY `fk_organizaciones_perfil_padre` (`organizacion_padre_id`);
...
ALTER TABLE `personas_perfil`
  ADD PRIMARY KEY (`usuario_id`),
  ADD KEY `fk_personas_perfil_tipos_sangre` (`tipo_sangre_id`),
  ADD KEY `fk_personas_perfil_direcciones` (`direccion_id`);
...
ALTER TABLE `puntos_donacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_puntos_donacion_tipos_punto_donacion` (`tipo_id`),
  ADD KEY `fk_puntos_donacion_usuarios` (`organizacion_responsable_id`),
  ADD KEY `fk_puntos_donacion_direcciones` (`direccion_id`);
...
ALTER TABLE `solicitudes_dispositivos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_sol_disp_avisos` (`aviso_id`);
...
ALTER TABLE `solicitudes_medicamentos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_sol_med_avisos` (`aviso_id`);
...
ALTER TABLE `solicitudes_sangre`
  ...
  ADD KEY `fk_sol_sangre_tipos_sangre` (`tipo_sangre_id`);
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `email_UNIQUE` (`email`),
  ADD KEY `fk_usuarios_tipos_usuario` (`tipo_usuario_id`),
...
ALTER TABLE `avisos`
  ...
  ADD CONSTRAINT `fk_avisos_usuarios_organizacion` FOREIGN KEY (`organizacion_id`) REFERENCES `usuarios` (`id`),
...
--
ALTER TABLE `avisos_documentos`
  ADD CONSTRAINT `fk_avisos_documentos_avisos` FOREIGN KEY (`aviso_id`) REFERENCES `avisos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `documentos`
--
ALTER TABLE `documentos`
  ADD CONSTRAINT `fk_documentos_tipos` FOREIGN KEY (`tipo_documento_id`) REFERENCES `tipos_documento` (`id`),
  ADD CONSTRAINT `fk_documentos_usuarios` FOREIGN KEY (`propietario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `donaciones`
--
ALTER TABLE `donaciones`
  ADD CONSTRAINT `fk_donaciones_avisos` FOREIGN KEY (`aviso_id`) REFERENCES `avisos` (`id`),
  ADD CONSTRAINT `fk_donaciones_estatus_donacion` FOREIGN KEY (`estatus_id`) REFERENCES `estatus_donacion` (`id`),
  ADD CONSTRAINT `fk_donaciones_usuarios` FOREIGN KEY (`donante_id`) REFERENCES `usuarios` (`id`);

--
-- Filtros para la tabla `donantes_beneficios`
--
ALTER TABLE `donantes_beneficios`
  ADD CONSTRAINT `fk_donantes_beneficios_donaciones` FOREIGN KEY (`donacion_id`) REFERENCES `donaciones` (`id`),
  ADD CONSTRAINT `fk_donantes_beneficios_empresas_apoyos` FOREIGN KEY (`apoyo_id`) REFERENCES `empresas_apoyos` (`id`),
  ADD CONSTRAINT `fk_donantes_beneficios_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);

--
-- Filtros para la tabla `empresas_apoyos`
--
ALTER TABLE `empresas_apoyos`
  ADD CONSTRAINT `fk_empresas_apoyos_tipos_apoyo` FOREIGN KEY (`tipo_apoyo_id`) REFERENCES `tipos_apoyo` (`id`),
  ADD CONSTRAINT `fk_empresas_apoyos_usuarios` FOREIGN KEY (`empresa_id`) REFERENCES `usuarios` (`id`);

--
-- Filtros para la tabla `empresas_perfil`
--
ALTER TABLE `empresas_perfil`
  ADD CONSTRAINT `fk_empresas_perfil_dir_comercial` FOREIGN KEY (`direccion_comercial_id`) REFERENCES `direcciones` (`id`),
  ADD CONSTRAINT `fk_empresas_perfil_dir_fiscal` FOREIGN KEY (`direccion_fiscal_id`) REFERENCES `direcciones` (`id`),
  ADD CONSTRAINT `fk_empresas_perfil_padre` FOREIGN KEY (`empresa_padre_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_empresas_perfil_representantes` FOREIGN KEY (`representante_id`) REFERENCES `representantes` (`id`),
  ADD CONSTRAINT `fk_empresas_perfil_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `organizaciones_perfil`
--
ALTER TABLE `organizaciones_perfil`
  ADD CONSTRAINT `fk_organizaciones_perfil_direcciones` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`),
  ADD CONSTRAINT `fk_organizaciones_perfil_padre` FOREIGN KEY (`organizacion_padre_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_organizaciones_perfil_representantes` FOREIGN KEY (`representante_id`) REFERENCES `representantes` (`id`),
  ADD CONSTRAINT `fk_organizaciones_perfil_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `personas_perfil`
--
ALTER TABLE `personas_perfil`
  ADD CONSTRAINT `fk_personas_perfil_direcciones` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_personas_perfil_tipos_sangre` FOREIGN KEY (`tipo_sangre_id`) REFERENCES `tipos_sangre` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_personas_perfil_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `personas_x_alergias`
--
ALTER TABLE `personas_x_alergias`
  ADD CONSTRAINT `fk_pxa_alergias` FOREIGN KEY (`alergia_id`) REFERENCES `alergias` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_pxa_personas` FOREIGN KEY (`usuario_id`) REFERENCES `personas_perfil` (`usuario_id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `personas_x_enfermedades`
--
ALTER TABLE `personas_x_enfermedades`
  ADD CONSTRAINT `fk_pxe_enfermedades` FOREIGN KEY (`enfermedad_id`) REFERENCES `enfermedades` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_pxe_personas` FOREIGN KEY (`usuario_id`) REFERENCES `personas_perfil` (`usuario_id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `puntos_donacion`
--
ALTER TABLE `puntos_donacion`
  ADD CONSTRAINT `fk_puntos_donacion_direcciones` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`),
  ADD CONSTRAINT `fk_puntos_donacion_tipos_punto_donacion` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_punto_donacion` (`id`),
  ADD CONSTRAINT `fk_puntos_donacion_usuarios` FOREIGN KEY (`organizacion_responsable_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL;

--
-- Filtros para la tabla `solicitudes_dispositivos`
--
ALTER TABLE `solicitudes_dispositivos`
  ADD CONSTRAINT `fk_sol_disp_avisos` FOREIGN KEY (`aviso_id`) REFERENCES `avisos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `solicitudes_medicamentos`
--
ALTER TABLE `solicitudes_medicamentos`
  ADD CONSTRAINT `fk_sol_med_avisos` FOREIGN KEY (`aviso_id`) REFERENCES `avisos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `solicitudes_sangre`
--
ALTER TABLE `solicitudes_sangre`
  ADD CONSTRAINT `fk_sol_sangre_avisos` FOREIGN KEY (`aviso_id`) REFERENCES `avisos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_sol_sangre_tipos_sangre` FOREIGN KEY (`tipo_sangre_id`) REFERENCES `tipos_sangre` (`id`);
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `fk_usuarios_tipos_usuario` FOREIGN KEY (`tipo_usuario_id`) REFERENCES `tipos_usuario` (`id`);
COMMIT;
