                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            if ($pagina_actual > 1) {
                                echo '<li class="page-item">
                                        <a class="page-link" href="?pagina=' . ($pagina_actual - 1) . '&busqueda=' . urlencode($busqueda) . '&municipio=' . urlencode($municipio) . '&estado=' . urlencode($estado) . '" aria-label="Anterior">
                            ...
                            for ($i = 1; $i <= $total_paginas; $i++) {
                                ...
                                echo '<li class="page-item ' . $clase_activa . '">
                                        <a class="page-link" href="?pagina=' . $i . '&busqueda=' . urlencode($busqueda) . '&municipio=' . urlencode($municipio) . '&estado=' . urlencode($estado) . '">' . $i . '</a>
                                    </li>';
                            }
                            ...
                            if ($pagina_actual < $total_paginas) {
                                echo '<li class="page-item">
                                        <a class="page-link" href="?pagina=' . ($pagina_actual + 1) . '&busqueda=' . urlencode($busqueda) . '&municipio=' . urlencode($municipio) . '&estado=' . urlencode($estado) . '" aria-label="Siguiente">
