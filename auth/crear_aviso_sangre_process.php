...
if ($_SERVER["REQUEST_METHOD"] !== "POST") {
    header('Location: ' . BASE_URL . 'avisos_crear_sangre.php');
    exit;
}
...
$categoria_id = 1; // Fijo para Sangre en este formulario.

// --- Datos específicos de la Solicitud de Sangre ---
...
try {
    ...
    if (isset($_FILES['documento']) && $_FILES['documento']['error'] === UPLOAD_ERR_OK) {
        $upload_dir = '../uploads/avisos_docs/sangre/';
        ...
        $db_path = 'uploads/avisos_docs/sangre/' . $new_file_name;
    ...
    // --- Vincular detalles del SANGRE con aviso ---
    ...
    $conexion->rollback();
    error_log("Error en crear_aviso_sangre_process.php: " . $e->getMessage());
