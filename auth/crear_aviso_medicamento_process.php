...
if ($_SERVER["REQUEST_METHOD"] !== "POST") {
    header('Location: ' . BASE_URL . 'avisos_crear_medicamento.php');
    exit;
}
...
try {
    ...
    if (isset($_FILES['documento']) && $_FILES['documento']['error'] === UPLOAD_ERR_OK) {
        $upload_dir = '../uploads/avisos_docs/medicamento/';
        ...
        $db_path = 'uploads/avisos_docs/medicamento/' . $new_file_name;
    ...
    $conexion->rollback();
    error_log("Error en crear_aviso_medicamento_process.php: " . $e->getMessage());
