...
<body>
    ...
    <div class="map-form-container">
        ...
        <div class="sidebar">
            ...
            <button type="submit" class="btn btn-primary w-100 py-3">Enviar Datos del Paciente</button>




<!-- Sección: Solicitud de Donación -->
...
<div class="form-container">
    ...
    <div class="form-floating mb-3">
        <select class="form-select border-1" id="catalogo-donacion" name="catalogo_donacion" required>
            ...
            <option value="2">Sangre2</option>
            <option value="3">Sangre</option>
            <option value="4">Otro</option>
        </select>
        <label for="catalogo-donacion">Catalago de opciones</label>
    </div>

    <!-- Centro de Donación -->
    <div class="form-floating mb-3">
        <select class="form-select border-1" id="puntos-donacion" name="puntos_donacion">
    ...
    <div class="form-floating mb-3">
        <select class="form-select border-1" id="unidad-medida" name="unidad_medida" required>
            ...
            <option value="ml">Donante</option>
            <option value="unidad">Unidad</option>
            <option value="caja">Caja</option>
        </select>
        <label for="unidad-medida">Unidades Requeridas</label>
    </div>
