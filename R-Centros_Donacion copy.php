        ...
        <div class="container-fluid blog py-3">
            <div class="container py-3">
                <div class="row g-4 justify-content-center">
                    ...
                    // Consulta para obtener los centros de donación
                    $sql = "SELECT * FROM centro_donacion"; // Asegúrate de que el nombre de la tabla sea correcto
                    ...
                    if ($resultado) {
                        if ($resultado->num_rows > 0) {
                            ...
                            echo '<div class="col-12 text-center">
                                    <p>No se encontraron centros de donación.</p>
                                </div>';
                        }
                    } else {
                        echo '<div class="col-12 text-center">
                                <p>Error al obtener los datos de los centros de donación.</p>
                            </div>';
                        error_log("Error en la consulta: " . $conexion->error); // Registrar el error en el log
                    }
