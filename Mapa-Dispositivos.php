...
<html lang="es">
  ...
  <script src="https://cdn.userway.org/widget.js" data-account="C07GrJafQK"></script>
    ...
    <style>
      .wrapper {
        background-color: #ffc107; /* Color amarillo (warning) */
      }
      .body {
        background-color: #ffc107; /* Color amarillo (warning) */
      }
    ...
    <script>
      ...
      function agregarMarcador(punto) {
        ...
        const marcador = new google.maps.Marker({
          ...
          title: punto.nombre,
          icon: {
            url: "assets/img/icon/silla.png", // Ruta de la imagen personalizada
      ...
      function seleccionarLugar(nombre, latitud, longitud) {
        ...
        window.location.href = "Con-Solicitar-Dispositivos.html";
      }
    </script>
