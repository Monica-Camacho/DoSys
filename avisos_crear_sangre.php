...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="container">
            <div>
                <h1 class='display-5 mb-0'>Crear Solicitud de Sangre</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <form class="row g-5" action="auth/crear_aviso_sangre_process.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-12"><label for="titulo" class="form-label">Título del Aviso</label><input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ej: Donadores de Sangre O+ para cirugía" required></div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6"><label for="solicitud_tipo_sangre" class="form-label">Tipo de Sangre Requerido</label><select id="solicitud_tipo_sangre" name="solicitud_tipo_sangre_id" class="form-select" required><option value="">Selecciona un tipo...</option><?php foreach ($tipos_sangre as $tipo): ?><option value="<?php echo $tipo['id']; ?>"><?php echo htmlspecialchars($tipo['nombre']); ?></option><?php endforeach; ?></select></div>
                                <div class="col-md-6"><label for="unidades" class="form-label">Unidades Requeridas</label><input type="number" class="form-control" id="unidades" name="unidades_requeridas" placeholder="Ej: 4" min="1" required></div>
                                <div class="col-12 mt-3"><label for="documento" class="form-label">Documento Médico de Soporte (Indispensable)</label><input type="file" class="form-control" id="documento" name="documento" required accept="application/pdf,image/jpeg,image/png"><small class="form-text text-muted">Sube la solicitud del hospital o la receta médica.</small></div>
                            </div>
                        </div>
                    </div>
                </div>
